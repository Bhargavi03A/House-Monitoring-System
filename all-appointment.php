                ...
                <div class="row">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered"> <thead> <tr> <th>#</th> 
							<th> User ID</th> 
							<th>Name & Address</th><th>Mobile Number</th> 
							<th>Start Date</th>
							<th>End Time</th>
							<th>Status</th>
							<th>Action</th> </tr> </thead> <tbody>
<?php
$ret=mysqli_query($con,"select user.name,user.address,user.email,user.mobile,tblbook.ID as bid,tblbook.AptNumber,tblbook.AptFrmDate,tblbook.AptToDate,tblbook.Message,tblbook.BookingDate,tblbook.Remark,tblbook.Status,tblbook.RemarkDate from tblbook join user on user.ID=tblbook.UserID");
$cnt=1;
