...
<link href="../assets/plugins/boostrapv3/css/admin_bootstrapmin.css" rel="stylesheet" type="text/css"/>
          ...
          <div class="grid simple no-border">
            ...
            <div class="grid-body  no-border" style="display:none">
              <div class="post">
				...
				<div class="info">Need Information about the status of the <b><?php echo $row['task_type'];?> </b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $row['ticket'];?></div>
