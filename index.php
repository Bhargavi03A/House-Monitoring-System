...
<body>
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        <h1 class="masthead-heading mb-0">Rural Development</h1>
        <h3>An ICT-enabled Mechanism to Monitor the home quality of Pradhan Mantri Awas Yojana 
Gramin Scheme</h3>
  ...
  <footer class="py-5 bg-black">
    <div class="container">
      <p class="m-0 text-center text-white small">Copyright &copy; RMK-Glance Village Hackathon</p>
    </div>
    <!-- /.container -->
  </footer>
