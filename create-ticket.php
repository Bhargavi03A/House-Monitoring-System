...
<meta charset="utf-8" />
<title>Rural Development | Create  ticket</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                               ...
                               <div class="form-group">                                        
									 ...
									 <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Construction Level</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select  name="tasktype" class="form-control select" required>
                                                ...
                                                <option value="Roofs">Roofs</option>
												 <option value="First and Second Fix">First and Second Fix</option>
