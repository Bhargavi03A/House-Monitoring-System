        ...
        <!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Manage Company</a>
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Company Name</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Service Name" value="<?php  echo $row['ServiceName'];?>" readonly="true"> </div>
